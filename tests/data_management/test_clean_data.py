...
import pandas as pd
import pytest
from forecasting_electricity_consumption_in_turkey.config import TEST_DIR
from forecasting_electricity_consumption_in_turkey.data_management import clean_data

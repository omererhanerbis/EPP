...
from forecasting_electricity_consumption_in_turkey.config import BLD, PAPER_DIR

documents = ["forecasting_electricity_consumption_in_turkey", "forecasting_electricity_consumption_in_turkey_pres"]
